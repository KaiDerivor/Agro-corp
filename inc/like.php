...
function getPostLikeLink($post_id){
   ...
   // $output='<li class="list-info__count-like no-active"><i class="fa-solid fa-heart"></i>'.$vote_count.'</li>';
}else{
    $output .= '<div class="svg_bottom_ico"><div class="like_ico noactive_svg" data-post_id="'.$post_id.'"></div></div>';
    $output .= '<span class="likecount"> '.$vote_count.'</span>';
   // $output='<li class="list-info__count-like is-active"><i class="fa-regular fa-heart"></i>'.$vote_count.'</li>';
    }
     return $output;
   }